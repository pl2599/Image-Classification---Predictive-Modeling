...
rgb_feature <- feature_rgb(img_train_dir, "train", data_name = "pets", export = F)
rgb_feature_test <- feature_rgb(img_test_dir, "test", data_name = "pets", export = F)
...
xgb_train <- train_xgboost(rgb_feature, label_train)
```
