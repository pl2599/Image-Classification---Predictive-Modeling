...
* Do model selection only with XGB
...
cat("Time for training xgb_rgb_model=", tm_xgb_rgb_pca_train[1], "s \n")
cat("Time for making xgb_rgb_prediction=", tm_xgb_rgb_pca_test[1], "s \n")
