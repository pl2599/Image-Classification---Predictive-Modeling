...
feature_SIFT_Ginny <- function(img_dir, set_name, data_name = "data", export = T){
  ...
  train_features_dir <- "/Users/admin/Desktop/Columbia/Spring 2018/Applied DS/Pet Images and Extracted Features - Project 2/Extracted SIFT features/"
